...
### A05 NAICS code
Value: 531120 - Lessors of Nonresidential Buildings (except Mini-warehouses)
Source: F1 p.3
> NAICS Code
...
| B003 | REQ | F1 p.4 | - | space should have no history of prior heavy industrial use such as large dry cleaning operations, gas stations, and industrial facilities. | [HUMAN] |
...
| B012 | REQ | F1 p.5 | - | parking-to-square-foot ratio available on site shall at least meet current local code requirements, or, in absence of a local code requirement, on-site parking shall be available at a ratio of 1 space for every 200 rsf of government-demised area. | [HUMAN] |
| B013 | REQ | F1 p.5 | - | adequate eating and banking facilities shall be located within the immediate vicinity of the building, but generally not exceeding a drivable two miles, as determined by the lco. | [HUMAN] |
| B014 | REQ | F1 p.5 | - | Offered space must meet Government requirements for fire safety, accessibility, seismic, and sustainability standards per the terms of the Lease. | [HUMAN] |
| B015 | REQ | F1 p.5 | - | A fully serviced lease is required. | [HUMAN] |
| B016 | REQ | F1 p.5 | - | Offered space shall not be in the 1-percent-annual chance floodplain (formerly referred to as 100-year floodplain). | [HUMAN] |
| B017 | REQ | F1 p.6 | - | Expressions of Interest must include the following: | [HUMAN] |
| B017a | REQ | F1 p.6 | 1) | Building name & address. | [HUMAN] |
| B017b | REQ | F1 p.6 | 2) | Contact information and e-mail address of Offeror's Representative. | [HUMAN] |
| B017c | REQ | F1 p.6 | 3) | ABOA and rentable square feet available (identifying the specific floors and square footage on each) | [HUMAN] |
| B017d | REQ | F1 p.6 | 4) | Asking rental rent | [HUMAN] |
| B017e | REQ | F1 p.6 | 5) | Floor Plan or Building Flyer | [HUMAN] |
| B017f | REQ | F1 p.6 | 6) | Date building will be ready for commencement of tenant improvements. | [HUMAN] |
| B017g | REQ | F1 p.6 | 7) | Offeror's name and address, and a written statement from Building Owner identifying Offeror's representative and granting authority to provide information on the property. | [HUMAN] |
...
|---|---|---|---|
| C01 | NOT SUPPLIED | F1 p.5 | per the terms of the Lease |
