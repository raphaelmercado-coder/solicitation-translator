...
FIXTURES = {
    ...
    "14-reformatted-phone": ("gsa-lease", "QUOTE",
        lambda t: t.replace("4042731268", "404-273-1268"),
        "phone number reformatted with hyphens, in value and quote"),
    "15-hyphen-in-id": ("gsa-lease", "QUOTE",
        lambda t: t.replace("0GA2194", "0GA-2194").replace("> 0GA219\n", "> 0GA-219\n"),
        "hyphen inserted into the notice ID"),
    "16-phone-hyphens-removed": ("gsa-lease", "QUOTE",
        lambda t: t.replace("212-326-1064", "2123261064"),
        "printed hyphens removed from a phone number"),
